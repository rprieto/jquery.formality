...
Formality was built as an aternative to <a href="http://github.com/luning/jquery.parcel">jQuery.parcel</a> for cases where we simply need to extract form values.
It does not intend to match the exhaustive features of parcel, but is faster in its limited domain.
